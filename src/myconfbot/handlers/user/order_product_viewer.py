...
from .order_constants import OrderConstants

logger = logging.getLogger(__name__)

class OrderProductViewer:
    ...
    ### Старые методы от product_viewer
    ...
    #     keyboard = OrderConstants.create_categories_keyboard_inline(
    ...
    #     # keyboard = OrderConstants.create_product_details_keyboard_inline(
    #     #     product=product,
    #     #     db_manager=self.db_manager,
    ...
    #             self.bot.send_message(
    #                 callback.message.chat.id,
    #                 OrderConstants.PRODUCT_MANAGEMENT_TITLE,
    #                 reply_markup=OrderConstants.create_management_keyboard(),
    #                 parse_mode='HTML'
    #             )
